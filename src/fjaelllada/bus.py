...
controller = ActuatorController(ControllerConfig(
    controller_id="act1",
    address=0x20,
    i2c_port=1,
))
...
def open_bay():
    controller.open_bay(Address(
        controller_register=0,
        register_bit_mask=0b00000001,
    ))
...
def main():
    ctl1 = ActuatorController(ControllerConfig(
        controller_id="act1",
        address=0x20,
        i2c_port=1,
    ))
